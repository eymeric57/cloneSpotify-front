  ...
  return (
    <div className="bg-gradient-to-b from-green_top to-transparent p-5 w-full flex items-center">
      <img
        ...
        className="w-28 h-28 rounded-full object-cover border-solid border-4 border-white lg:w-48 lg:h-48"
      />
      <div className="ml-10 flex flex-col justify-end">
        <h1 className="text-3xl lg:text-5xl font-bold text-white my-7">
          {name}
        </h1>
      </div>
    </div>
